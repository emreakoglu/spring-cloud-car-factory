package com.car.factory.carengine.config;
...
public class SwaggerConfig extends WebMvcConfigurationSupport{
	...
	private ApiInfo metadata() {
		return new ApiInfoBuilder().title("Car Factory Engine Boot Swagger").description("\"Car Factory Engine Spring Boot Uygulaması\"")
