...
public class SwaggerConfig extends WebMvcConfigurationSupport{
	...
	public Docket productApi() {
		...
		return new Docket(DocumentationType.SWAGGER_2)
				.host("localhost:8085")
				.pathMapping("car-factory-employees")
	...
	private ApiInfo metadata() {
		return new ApiInfoBuilder().title("Car Factory Employees Boot Swagger").description("\"Car Factory Employees Spring Boot Uygulaması\"")
